...
python early:
    config.save_directory = "Secure Self-Attachment Therapy-1370798003"
...
init python:
    ...
    build.directory_name = "Secure Self-Attachment Therapy-1.0"
    
    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Secure Self-Attachment Therapy"
